...
public class Cart extends HttpServlet {
	...
	protected void displayCart(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		for (OrderItem oi : helper.getCustomerOrders()) {
			...
			pw.print("<td><form method='post' action='Remove'><input type='hidden' name='Remove' value='"+oi.getName()+"'>");
			pw.print("<input type='submit' class='btnbuy' value='Remove Item' style='float: left;height: 5px margin: 5px; margin-right: 10px; '></input></form></td>");			
			pw.print("</tr>");
