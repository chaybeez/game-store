...
public class AddGame extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(!helper.isLoggedin()){
			...
			displayGames(request, response, pw, true);
		}	
	}
	
	protected void displayGames(HttpServletRequest request, HttpServletResponse response, PrintWriter pw, boolean error) throws ServletException, IOException {
		Helper helper = new Helper(request, pw);
		...
		pw.print("<h2 class='title meta'><a style='font-size: 24px;'>GameSpeed Game Inventory</a></h2>"
				+ "<div class='entry'>"
		...
		if (!usertype.equals("manager")){
			...
			pw.print("<table  class='gridtable'>");
				for (Game t : GameHashMap.electronicArts.values()){
				...
				for (Game t : GameHashMap.activision.values()){
					pw.print("<h5 style='color:black'>Name: " + t.getName() + "</h5>" +
					"<h5 style='color:black'>Price: " + t.getPrice() + "</h5>" +
					"<h5 style='color:black'>Condition: " + t.getCondition() + "</h5>" +
					"<h5 style='color:black'>Discount: " + t.getDiscount() + "</h5>" +
				...
				for (Game t : GameHashMap.takeTwoInteractive.values()){
					pw.print("<h5 style='color:black'>Name: " + t.getName() + "</h5>" +
					"<h5 style='color:black'>Price: " + t.getPrice() + "</h5>" +
					"<h5 style='color:black'>Condition: " + t.getCondition() + "</h5>" +
					"<h5 style='color:black'>Discount: " + t.getDiscount() + "</h5>" +
