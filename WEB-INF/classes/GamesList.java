...
public class GamesList extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if (request.getParameter("key") != null){
			...
			else if(retailer.equals("Activision")){
				hm.putAll(GameHashMap.activision);
				res = hm.get(key);
			}
			else if(retailer.equals("Take-Two Interactive")){
			...
			pw.print("<a style='font-size: 24px;'>"+retailer+" Games</a>");
			pw.print("</h2><div class='entry'><table id='bestseller'>");
			pw.print("<tr>");
			pw.print("<td><div id='shop_item'>");
			pw.print("<h3>"+res.getName()+"</h3>");
			pw.print("<strong>"+ "$" + res.getPrice() + "</strong><ul>");
			pw.print("<li id='item'><img src='images/games/"+res.getImage()+"' alt='' /></li>");
			...
			pw.print("<li><a class='btnreview' href='Review?name="+key+"&type=games&maker="+retailer+"&access='>Reviews</a></li>");
